...
AddRectAction::AddRectAction(ApplicationManager * pApp):Action(pApp)
{
	if (pManager->getSound() == true)
		sndPlaySound(TEXT("Sound\\Rectangle.wav"), SND_FILENAME | SND_ASYNC);
}
...
{	
	...
	{
		pOut->PrintMessage("New Rectangle: Wrong place..Reclick at first corner");
		pIn->GetPointClicked(P1.x, P1.y);
	}
	...
	{
		pOut->PrintMessage("New Rectangle: Wrong place..Reclick at second corner");
		pIn->GetPointClicked(P2.x, P2.y);
	}
